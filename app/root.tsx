  ...
  return (
    <html lang="pt-BR">
      ...
      <body className="bg-slate-200">
        ...
        <Outlet />
        <div className={`inset-0 bg-white/50 absolute items-center justify-center ${transition.state === "idle" ? "hidden" : "flex"}`}>
          <div className={`${transition.state === "idle" ? "opacity-100" : "opacity-100"}`}>
